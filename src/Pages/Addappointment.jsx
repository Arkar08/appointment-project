    ...
    <>
      ...
      >
        <div className="border w-[350px] h-[100%] shadow-lg rounded-lg mb-4">
          <h2 className="text-center pt-2 text-3xl font-bold text-blue-300">
            Made An Appointment
          </h2>
          <div className="relative w-[100%] h-[80px] px-4 mt-2">
            ...
            <div className="relative h-[40px] mt-2">
              <input
                type="text"
                className="border w-[100%] h-[100%] p-2 rounded-md"
                name="patientID"
                value={input}
          ...
          <div className="w-[100%] h-[80px] px-4 mt-2 flex flex-col">
            ...
            <input
              type="datetime-local"
              className="w-[100%] mt-2 border rounded-md h-[100%]"
              value={todate}
              name="date"
          ...
          <div className="flex w-[100%] h-[40px] mt-4 px-4">
            <label className="text-xl font-bold mr-4 text-center text-sky-600">
              Status
            </label>
            <select
              name="Status"
              className="w-[100%] border rounded-md h-[100%] "
              onClick={handleStatus}
            >
              <option
                value="Approved"
                className="texl-xl font-semibold text-gray-500"
              >
                Approved
              </option>
              <option
          ...
          <div className="flex items-center justify-center m-4">
            <input
              type="submit"
              className="py-2 w-[200px] bg-green-400 text-white cursor-pointer text-xl font-semibold rounded-md"
              onClick={() =>
                setUserData({
                  ...userData,
                  patientId: input,
