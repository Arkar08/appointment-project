  ...
  return (
    <form className="flex justify-center items-center mt-8">
      <div className="border w-[350px] h-[100%] shadow-lg rounded-lg mb-4">
        <h2 className="text-center pt-2 text-3xl font-bold text-red-600">
        ...
        <div className=" w-[100%] h-[80px] px-4 mt-4">
          ...
          <input
            ...
            className="border w-[100%] h-[40px] p-2 rounded-md mt-2"
        ...
        <div className=" w-[100%] h-[50px] px-4 mt-2">
          ...
          <input
            type="datetime-local"
            className="w-[80%] mt-2 border rounded-md h-[40px]"
            value={data.date}
          />
        </div>
        <div className=" w-[100%] h-[80px] px-4 mt-2">
        ...
        <div className="flex items-center justify-center m-4">
          <input
            type="submit"
            className="py-2 w-[200px] bg-gray-400 cursor-pointer text-xl font-semibold rounded-md"
          />
        </div>
      </div>
    </form>
